    <div class="content_area">
      <div class="main_content floatleft">
        <div class="single_left_coloum_wrapper">
          ...
          <h2 class="title"><?php echo $upst['judul']; ?></h2>
          <span class="entry-date">
            <div style="padding-left: 12px;"><?= $upst['updated_at']; ?>  |  <?= $upst['uploadby']; ?></div>
          </span>
          <br>
          <div style="padding-left: 12px;"><p><?php echo $upst['isi']; ?></p> </div>
