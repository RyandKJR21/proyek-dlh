    <div class="content_area">
      <div class="main_content floatleft">
        <div class="single_left_coloum_wrapper">
          ...
          <h2 class="title"><?php echo $struktur_organisasi['judul']; ?></h2>
          <span class="entry-date">
            <div style="padding-left: 12px;"><?= $struktur_organisasi['updated_at']; ?>  |  <?= $struktur_organisasi['uploadby']; ?></div>
          </span>
          <br>
          <img src="<?=base_url('assets/img/img_struktur_organisasi/') . $struktur_organisasi['image']; ?>" alt="<?= $struktur_organisasi['image']; ?>" />
          <div style="padding-left: 12px;"><p><?php echo $struktur_organisasi['isi']; ?></p> </div>
