    <div class="content_area">
      <div class="main_content floatleft">
        <div class="single_left_coloum_wrapper">
          ...
          <h2 class="title"><?php echo $profil['judul']; ?></h2>
          <span class="entry-date">
            <div style="padding-left: 12px;"><?= $profil['updated_at']; ?>  |  <?= $profil['uploadby']; ?></div>
          </span>
          <br>
          <img src="<?=base_url('assets/img/img_profil/') . $profil['image']; ?>" alt="<?= $profil['image']; ?>" />
          <div style="padding-left: 12px;"><p><?php echo $profil['isi']; ?></p> </div>
