    <div class="content_area">
      <div class="main_content floatleft">
        <div class="single_left_coloum_wrapper">
          ...
          <h2 class="title"><?php echo $t_ppkl['judul']; ?></h2>
          <span class="entry-date">
            <div style="padding-left: 12px;"><?= $t_ppkl['updated_at']; ?>  |  <?= $t_ppkl['uploadby']; ?></div>
          </span>
          <br>
          <div style="padding-left: 12px;"><p><?php echo $t_ppkl['isi']; ?></p> </div>
