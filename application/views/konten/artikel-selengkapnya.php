    <div class="content_area">
      <div class="main_content floatleft">
        <div class="single_left_coloum_wrapper">
          ...
          <h2 class="title"><?php echo $selengkapnya['judul']; ?></h2>
          <span class="entry-date">
            <div style="padding-left: 12px;"><?= $selengkapnya['tanggal']; ?>  |  <?= $selengkapnya['uploadby']; ?></div>
          </span>
          <br>
          <img src="<?=base_url('assets/img/img_artikel/') . $selengkapnya['image']; ?>" alt="<?= $selengkapnya['image']; ?>" />
          <div style="padding-left: 12px;"><p><?php echo $selengkapnya['isi']; ?></p> </div>
