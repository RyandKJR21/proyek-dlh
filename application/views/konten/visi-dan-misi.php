    <div class="content_area">
      <div class="main_content floatleft">
        <div class="single_left_coloum_wrapper">
          ...
          <h2 class="title"><?php echo $visi_misi['judul']; ?></h2>
          <span class="entry-date">
            <div style="padding-left: 12px;"><?= $visi_misi['updated_at']; ?>  |  <?= $visi_misi['uploadby']; ?></div>
          </span>
          <br>
          <div style="padding-left: 12px;"><p><?php echo $visi_misi['isi']; ?></p> </div>
