<!-- Begin Page Content -->
        ...
        <?= form_open_multipart(''); ?>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
                            <textarea type="text" name="isi" class="form-control" id="summernote"> <?= $vm['isi']; ?></textarea>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
                          <input type="text" name="uploadby" class="form-control" value="<?= $vm['uploadby']; ?>" />
          ...
          <div class="form-group row justify-content-end">
            <div class="col-sm-10">
              ...
              <a href="<?php echo base_url('berita/data_visi_misi'); ?>"
