<!-- Begin Page Content -->
        ...
        <?= form_open_multipart(''); ?>
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" name="judul" class="form-control" id="judul" value="<?= $upk['judul']; ?>">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
                            <textarea type="text" name="isi" class="form-control" id="summernote"> <?= $upk['isi']; ?></textarea>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
                          <input type="text" name="uploadby" class="form-control" value="<?= $upk['uploadby']; ?>" />
